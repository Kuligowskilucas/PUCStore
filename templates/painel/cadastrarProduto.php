<div class="container mx-auto py-24">
  ...
  <form action="templates/painel/processos/formulario_produto.php" method="POST" enctype="multipart/form-data">
    <div class="mb-4">
    ...
    <div class="mb-4">
      ...
      <input type="text" name="nome" id="nome" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none   
 focus:shadow-outline" placeholder="Nome do produto">
    ...
    <div class="mb-4">
      ...
      <input type="number" name="price" id="price" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none   
