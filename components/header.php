<div class="bg-gray-800 text-white py-4">
    <div class="max-w-[1200px] mx-auto px-4 flex items-center justify-between flex-row">
        ...
        <div class="flex flex-row gap-8 items-center">
            <a href="index.php?page=cadastro" class="text-x2 font-bold">Sing up</a>
            <a class="bg-blue-500 text-white font-bold py-2 px-4 rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-300" href="index.php?page=painel/loginPainel">Login Admin</a>
        </div>
    </div>
</div>
